    ...
    <div class="container-fluid">
        ...
        <div class="row mt-3">
            <div class="table-responsive">
                <table class="table table-bordered" width="100%" cellspacing="0" style="border: 1px #000 solid;" style="border: 1px #000 solid;">
                    <thead>
                        <tr class="text-center align-items-center">
                            <th style="border: 1px #000 solid;">No</th>
                            <th style="border: 1px #000 solid;">Nama</th>
                            <td style="border: 1px #000 solid;">Buku</td>
                            <th style="border: 1px #000 solid;">Tgl Pinjam</th>
                            <th style="border: 1px #000 solid;">Tgl Perpanjang</th>
                            <th style="border: 1px #000 solid;">Tgl Pengembalian</th>
                    ...
                    <tbody id="tbody">
                        ...
                        <tr class="align-items-center">
                            ...
                            <td class="text-center" style="border: 1px #000 solid;">@if ($item->tgl_panjang == NULL)
                                ...
                                @endif</td>
                            <td class="text-center" style="border: 1px #000 solid;">{{ Carbon\Carbon::parse($item->tgl_pengembalian)->format('d-m-Y') }}</td>
