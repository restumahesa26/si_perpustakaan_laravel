...
<body>
    <div class="container-fluid">
        ...
        <h5 class="text-center mt-3">Laporan Peminjaman dan Pengembalian</h5>
                    ...
                    <tbody id="tbody">
                        ...
                        <tr class="align-items-center">
                            ...
                            <td class="text-center" style="border: 1px #000 solid;">@if ($item->tgl_panjang == NULL)
                                ...
                                @endif</td>
                            <td class="text-center" style="border: 1px #000 solid;">@if ($item->tgl_pengembalian == NULL)
                                -
                            @else
                            ...
                            <td class="text-center" style="border: 1px #000 solid;">{{ $item->status }}</td>
