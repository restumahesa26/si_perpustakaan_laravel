...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="card-show">
            <div class="card-body">
                <form action="{{ route('data-pengadaan.update', $item->idPengadaan) }}" method="POST" class="form" id="form">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <input id="asal_buku" type="text" class="form-control @error('asal_buku') is-invalid @enderror" name="asal_buku" placeholder="Asal Buku" value="{{ $item->asal_buku }}">
                        @error('asal_buku')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group">
                        ...
                        <input id="jumlah" type="number" class="form-control @error('jml_masuk') is-invalid @enderror" name="jml_masuk" placeholder="Jumlah Masuk" value="{{ $item->jml_masuk }}">
                        @error('jml_masuk')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group">
                        ...
                        <input id="tanggal" type="text" class="date form-control @error('tanggal') is-invalid @enderror" name="tanggal" autocomplete="off" value="{{ $item->tanggal }}">
                        @error('tanggal')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group">
                        ...
                        placeholder="Keterangan"> {{ $item->keterangan }}
                        </textarea>
                        @error('keterangan')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
